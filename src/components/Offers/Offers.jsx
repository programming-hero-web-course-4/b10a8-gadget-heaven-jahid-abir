    ...
    return (
        <div>
            ...
            <div className='bg-primary text-center space-y-4 py-10 rounded-2xl'>
                <h3 className='font-bold text-6xl w-3/4 mx-auto text-white'>Offers</h3>
                <p className='w-1/2 mx-auto text-gray-100'>Grab the hottest deals with exclusive discounts on a wide range of products. Limited-time offers you don’t want to miss!</p>
            </div>
