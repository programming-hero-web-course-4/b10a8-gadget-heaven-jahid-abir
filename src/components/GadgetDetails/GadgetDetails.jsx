                    ...
                    <div className="hero bg-white py-20 rounded-xl">
                        <div className="hero-content flex-col lg:flex-row">
                            ...
                            <div className="space-y-2">
                                ...
                                <p>{description}</p>
                                <div><span className='font-bold text-xl'>Specification :</span> {Specification.map((speck, idx) => <li key={idx} speck={speck}>{speck}</li>)}</div>
                                ...
                                <div className="flex gap-5">
                                    <button onClick={() => handleSelectedItems(gadgetData)} className='flex items-center gap-3 px-4 py-2 rounded-2xl bg-primary text-white font-bold'><MdOutlineShoppingCart /> Add To Card</button>
